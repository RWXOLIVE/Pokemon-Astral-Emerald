...
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_NormalTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_FireTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_WaterTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_ElectricTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GrassTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_IceTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_FightingTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_PoisonTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GroundTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_FlyingTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_PsychicTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BugTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_RockTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GhostTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_DragonTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_DarkTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_SteelTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_FairyTM;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HeartScale;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_RareCandy;
extern const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TyrantrumStatue;
...
#endif // IS_FRLG
    [OBJ_EVENT_GFX_NORMAL_TM]              = &gObjectEventGraphicsInfo_NormalTM,
    [OBJ_EVENT_GFX_FIRE_TM]                = &gObjectEventGraphicsInfo_FireTM,
    [OBJ_EVENT_GFX_WATER_TM]               = &gObjectEventGraphicsInfo_WaterTM,
    [OBJ_EVENT_GFX_ELECTRIC_TM]            = &gObjectEventGraphicsInfo_ElectricTM,
    [OBJ_EVENT_GFX_GRASS_TM]               = &gObjectEventGraphicsInfo_GrassTM,
    [OBJ_EVENT_GFX_ICE_TM]                 = &gObjectEventGraphicsInfo_IceTM,
    [OBJ_EVENT_GFX_FIGHTING_TM]            = &gObjectEventGraphicsInfo_FightingTM,
    [OBJ_EVENT_GFX_POISON_TM]              = &gObjectEventGraphicsInfo_PoisonTM,
    [OBJ_EVENT_GFX_GROUND_TM]              = &gObjectEventGraphicsInfo_GroundTM,
    [OBJ_EVENT_GFX_FLYING_TM]              = &gObjectEventGraphicsInfo_FlyingTM,
    [OBJ_EVENT_GFX_PSYCHIC_TM]             = &gObjectEventGraphicsInfo_PsychicTM,
    [OBJ_EVENT_GFX_BUG_TM]                 = &gObjectEventGraphicsInfo_BugTM,
    [OBJ_EVENT_GFX_ROCK_TM]                = &gObjectEventGraphicsInfo_RockTM,
    [OBJ_EVENT_GFX_GHOST_TM]               = &gObjectEventGraphicsInfo_GhostTM,
    [OBJ_EVENT_GFX_DRAGON_TM]              = &gObjectEventGraphicsInfo_DragonTM,
    [OBJ_EVENT_GFX_DARK_TM]                = &gObjectEventGraphicsInfo_DarkTM,
    [OBJ_EVENT_GFX_STEEL_TM]               = &gObjectEventGraphicsInfo_SteelTM,
    [OBJ_EVENT_GFX_FAIRY_TM]               = &gObjectEventGraphicsInfo_FairyTM,
    [OBJ_EVENT_GFX_HEART_SCALE]              = &gObjectEventGraphicsInfo_HeartScale,
