...
static const struct SpriteFrameImage sPicTable_NormalTM[] = {
    overworld_frame(gObjectEventPic_NormalTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_FireTM[] = {
    overworld_frame(gObjectEventPic_FireTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_WaterTM[] = {
    overworld_frame(gObjectEventPic_WaterTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_ElectricTM[] = {
    overworld_frame(gObjectEventPic_ElectricTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_GrassTM[] = {
    overworld_frame(gObjectEventPic_GrassTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_IceTM[] = {
    overworld_frame(gObjectEventPic_IceTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_FightingTM[] = {
    overworld_frame(gObjectEventPic_FightingTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_PoisonTM[] = {
    overworld_frame(gObjectEventPic_PoisonTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_GroundTM[] = {
    overworld_frame(gObjectEventPic_GroundTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_FlyingTM[] = {
    overworld_frame(gObjectEventPic_FlyingTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_PsychicTM[] = {
    overworld_frame(gObjectEventPic_PsychicTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_BugTM[] = {
    overworld_frame(gObjectEventPic_BugTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_RockTM[] = {
    overworld_frame(gObjectEventPic_RockTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_GhostTM[] = {
    overworld_frame(gObjectEventPic_GhostTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_DragonTM[] = {
    overworld_frame(gObjectEventPic_DragonTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_DarkTM[] = {
    overworld_frame(gObjectEventPic_DarkTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_SteelTM[] = {
    overworld_frame(gObjectEventPic_SteelTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_FairyTM[] = {
    overworld_frame(gObjectEventPic_FairyTM, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_HeartScale[] = {
    overworld_frame(gObjectEventPic_HeartScale, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_RareCandy[] = {
    overworld_frame(gObjectEventPic_RareCandy, 2, 2, 0),
};

static const struct SpriteFrameImage sPicTable_TyrantrumStatue[] = {
    obj_frame_tiles(gObjectEventPic_TrantrumStatue)
};
