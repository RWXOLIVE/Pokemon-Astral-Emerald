...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_FLORAGATO}),
    },
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_CROCALOR}),
    },
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_QUAXWELL}),
    },
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .abilities = { ABILITY_HARVEST, ABILITY_TRIAGE, ABILITY_SEED_SOWER },
        .bodyColor = BODY_COLOR_GREEN,
