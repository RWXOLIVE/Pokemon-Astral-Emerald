...
static const u8 sCantBeUseTwiceDescription[] = _(
    "Cant be used twice in a\n"
    "row.");
...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_VOLT_VOLLEY] =
    {
        .name = COMPOUND_STRING("Volt Volley"),
        .description = COMPOUND_STRING(
            "A striking kick. May\n"
            "leave the foe stunned."),
        .power = 70,
        .effect = EFFECT_HIT,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_DOUBLE_EDGE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "also hurts the user."),
        .effect = EFFECT_RECOIL,
        .power = B_UPDATED_MOVE_DATA >= GEN_2 ? 130 : 100,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HYPER_BEAM] =
    {
        ...
        .description = sCantBeUseTwiceDescription,
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_NORMAL,
        .accuracy = 90,
    ...
    [MOVE_FROST_BLAST] =
    {
        .name = COMPOUND_STRING("Frost Blast"),
        .description = COMPOUND_STRING(
            "Powerful, but leaves the\n"
            "user immobile the next turn."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_AROMATIC_MIST] = //make this a specical coaching
    {
    ...
    [MOVE_SCALE_CHOMP] =
    {
        .name = COMPOUND_STRING("Scale Chomp"),
        .description = COMPOUND_STRING(
            "Savage chomp that may raise\n"
            "speed but may lower defense."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_METEOR_BEAM] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .instructBanned = TRUE,
        .argument.twoTurnAttack = { .stringId = STRINGID_METEORBEAMCHARGING, .status = B_WEATHER_SANDSTORM },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_ATK_PLUS_1,
            .self = TRUE,
            .onChargeTurnOnly = TRUE,
    ...
    [MOVE_AQUA_FANGS] =
    {
        .name = COMPOUND_STRING("Aqua Fangs"),
        .description = COMPOUND_STRING(
            "Chomps with aqua fangs.\n"
            "Destroys any barriers."),
        .effect = EFFECT_BRICK_BREAK,
        .power = 85,
        .type = TYPE_WATER,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_AquaFangs,
    },
