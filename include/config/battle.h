...
#define B_FLAG_FORCE_DOUBLE_WILD    0x49     // If this flag is set, all land and surfing wild battles will be double battles.
...
#define B_VAR_STARTING_STATUS       0x404E     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active.
