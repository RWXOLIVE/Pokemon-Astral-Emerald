...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x45 // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x48 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x44 // Allow player to find hidden mons
#define DN_VAR_SPECIES                0x47 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           0x43 // Steps for finding hidden pokemon
