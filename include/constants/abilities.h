...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_FLORAL_PAYLOAD = 311,
    ABILITY_HEART_BOOST = 312,
    ABILITY_INFESTATE = 313,
    ABILITY_LUNAR_VEIL = 314,
    ABILITY_SOLAR_VEIL = 315,
    ABILITY_BLAZING_SOUL = 316,
    ABILITY_GRIT = 317,
    ABILITY_SHROUD = 318,
    ABILITY_LUCID = 319,
    ABILITY_STRIKER = 320,
    ABILITY_HEATED_RUSH = 321,
    ABILITY_LUCHADORS_PRIDE = 322,
    ABILITY_ECHOING_ALLOY = 323,
