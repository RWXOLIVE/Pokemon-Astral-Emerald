...
#define VAR_PERMA_STATUS                                0x404E // Perma Terrain
...
#define VAR_USING_KEYITEM                                0x40BB // Unused Var
...
#define VAR_QOL_TIME_OVERRIDE                            0x40FF // Stores a persistent quick-menu time override as (hour + 1), or 0 to follow the clock.
