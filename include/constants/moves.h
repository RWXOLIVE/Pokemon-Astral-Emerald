...
#define MOVE_TECTONIC_RAGE 849
#define MOVE_VOLT_VOLLEY 850
#define MOVE_AQUA_FANGS 851
#define MOVE_FROST_BLAST 852
#define MOVE_SCALE_CHOMP 853
#define MOVE_HP_WATER 854
#define MOVE_HP_ICE 855
#define MOVE_HP_FIRE 856
#define MOVE_HP_GROUND 857
#define MOVE_HP_DARK 858
#define MOVE_HP_ELECTRIC 859
#define MOVE_HP_ROCK 860
#define MOVE_HP_GRASS 861
#define MOVE_HP_DRAGON 862
#define MOVE_HP_FAIRY 863
#define MOVE_HP_PSYCHIC 864
#define MOVE_HP_BUG 865
#define MOVE_HP_FLYING 866
#define MOVE_HP_GHOST 867
#define MOVE_HP_POISON 868
#define MOVE_HP_STEEL 869
#define MOVE_HP_FIGHTING 870

#define MOVES_COUNT_GEN9 871
...
#define MOVE_CONTINENTAL_CRUSH (MOVES_COUNT + 4)
#define MOVE_SAVAGE_SPIN_OUT (MOVES_COUNT + 5)
#define MOVE_NEVER_ENDING_NIGHTMARE (MOVES_COUNT + 6)
#define MOVE_CORKSCREW_CRASH (MOVES_COUNT + 7)
#define MOVE_INFERNO_OVERDRIVE (MOVES_COUNT + 8)
#define MOVE_HYDRO_VORTEX (MOVES_COUNT + 9)
#define MOVE_BLOOM_DOOM (MOVES_COUNT + 10)
#define MOVE_GIGAVOLT_HAVOC (MOVES_COUNT + 11)
#define MOVE_SHATTERED_PSYCHE (MOVES_COUNT + 12)
#define MOVE_SUBZERO_SLAMMER (MOVES_COUNT + 13)
#define MOVE_DEVASTATING_DRAKE (MOVES_COUNT + 14)
#define MOVE_BLACK_HOLE_ECLIPSE (MOVES_COUNT + 15)
#define MOVE_TWINKLE_TACKLE (MOVES_COUNT + 16)

// Signature Z Moves
#define MOVE_CATASTROPIKA (MOVES_COUNT + 17)
#define MOVE_10000000_VOLT_THUNDERBOLT (MOVES_COUNT + 18)
#define MOVE_10_000_000_VOLT_THUNDERBOLT MOVE_10000000_VOLT_THUNDERBOLT
#define MOVE_STOKED_SPARKSURFER (MOVES_COUNT + 19)
#define MOVE_EXTREME_EVOBOOST (MOVES_COUNT + 20)
#define MOVE_PULVERIZING_PANCAKE (MOVES_COUNT + 21)
#define MOVE_GENESIS_SUPERNOVA (MOVES_COUNT + 22)
#define MOVE_SINISTER_ARROW_RAID (MOVES_COUNT + 23)
#define MOVE_MALICIOUS_MOONSAULT (MOVES_COUNT + 24)
#define MOVE_OCEANIC_OPERETTA (MOVES_COUNT + 25)
#define MOVE_SPLINTERED_STORMSHARDS (MOVES_COUNT + 26)
#define MOVE_LETS_SNUGGLE_FOREVER (MOVES_COUNT + 27)
#define MOVE_CLANGOROUS_SOULBLAZE (MOVES_COUNT + 28)
#define MOVE_GUARDIAN_OF_ALOLA (MOVES_COUNT + 29)
#define MOVE_SEARING_SUNRAZE_SMASH (MOVES_COUNT + 30)
#define MOVE_MENACING_MOONRAZE_MAELSTROM (MOVES_COUNT + 31)
#define MOVE_LIGHT_THAT_BURNS_THE_SKY (MOVES_COUNT + 32)
#define MOVE_SOUL_STEALING_7_STAR_STRIKE (MOVES_COUNT + 33)
