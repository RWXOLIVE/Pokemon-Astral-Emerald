...
// Object event pals
extern const u32 gObjectEventPic_NormalTM[];
extern const u16 gObjectEventPal_NormalTM[];
extern const u32 gObjectEventPic_FireTM[];
extern const u16 gObjectEventPal_FireTM[];
extern const u32 gObjectEventPic_WaterTM[];
extern const u16 gObjectEventPal_WaterTM[];
extern const u32 gObjectEventPic_ElectricTM[];
extern const u16 gObjectEventPal_ElectricTM[];
extern const u32 gObjectEventPic_GrassTM[];
extern const u16 gObjectEventPal_GrassTM[];
extern const u32 gObjectEventPic_IceTM[];
extern const u16 gObjectEventPal_IceTM[];
extern const u32 gObjectEventPic_FightingTM[];
extern const u16 gObjectEventPal_FightingTM[];
extern const u32 gObjectEventPic_PoisonTM[];
extern const u16 gObjectEventPal_PoisonTM[];
extern const u32 gObjectEventPic_GroundTM[];
extern const u16 gObjectEventPal_GroundTM[];
extern const u32 gObjectEventPic_FlyingTM[];
extern const u16 gObjectEventPal_FlyingTM[];
extern const u32 gObjectEventPic_PsychicTM[];
extern const u16 gObjectEventPal_PsychicTM[];
extern const u32 gObjectEventPic_BugTM[];
extern const u16 gObjectEventPal_BugTM[];
extern const u32 gObjectEventPic_RockTM[];
extern const u16 gObjectEventPal_RockTM[];
extern const u32 gObjectEventPic_GhostTM[];
extern const u16 gObjectEventPal_GhostTM[];
extern const u32 gObjectEventPic_DragonTM[];
extern const u16 gObjectEventPal_DragonTM[];
extern const u32 gObjectEventPic_DarkTM[];
extern const u16 gObjectEventPal_DarkTM[];
extern const u32 gObjectEventPic_SteelTM[];
extern const u16 gObjectEventPal_SteelTM[];
extern const u32 gObjectEventPic_FairyTM[];
extern const u16 gObjectEventPal_FairyTM[];
extern const u32 gObjectEventPic_HeartScale[];
extern const u16 gObjectEventPal_HeartScale[];
extern const u32 gObjectEventPic_RareCandy[];
extern const u16 gObjectEventPal_RareCandy[];
